...
import { defaultProductFilter, productFilterSchema } from "@ecommerce/api/schemas";
...
export const adminProductSearchParamsParser = {
  ...
  filter: parseAsJson((value) => productFilterSchema.optional().parse(value)).withDefault(
    defaultProductFilter
  ),
};

export const loadAdminProductSearchParams = createLoader(adminProductSearchParamsParser);
